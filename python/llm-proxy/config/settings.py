"""
Application settings loaded from environment / .env file using Pydantic's
BaseSettings.
"""
...
class Settings(BaseSettings):
    """
    Central configuration for the LLM Proxy.

    Reads from environment variables or a ``.env`` file.  All fields are
    documented below with their defaults.
    """
